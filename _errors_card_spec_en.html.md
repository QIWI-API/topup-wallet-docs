...
-----|--------
0| No errors
155|Invalid service code (tag `to/service-id` in top-up request should be `32911` for payment card top up, and `99` for QIWI Wallet top up)
...
`to/service-id`	| Constant (`32911` for payment card top up, `99` for QIWI Wallet top up)
